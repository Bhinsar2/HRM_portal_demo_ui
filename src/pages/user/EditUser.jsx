...
const EditUser = () => {
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        if (formData.type && !showModal && formData.type !== userType) return setShowModal(true);

        console.log("Updating User Data (JSON):", formData);
        const { success, message } = await updateUser(id, formData);
